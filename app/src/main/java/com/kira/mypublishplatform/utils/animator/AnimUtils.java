package com.kira.mypublishplatform.utils.animator;
...
import com.kira.mypublishplatform.utils.DimensUtils;
...
public class AnimUtils {
    ...
    public static ObjectAnimator getShakeUp(View view, float scaleMax, float rotation) {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(
                view, pvhScaleX, pvhScaleY, pvhRotation).setDuration(2000);
    ...
    public static void shakeLeft(View view, float scaleMax, float translation) {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(
                view, pvhScaleX, pvhScaleY, pvhRotation).setDuration(800);
