...
import com.kira.mypublishplatform.utils.DrawableUtils;
...
public class FlatButton extends TextView {
    ...
    private LayerDrawable createNormalDrawable(TypedArray attr) {
        ...
        layerDrawable.setLayerInset(1, 0, 0, DimensUtils.dip2px(getContext(), 1), DimensUtils.dip2px(getContext(), 2));
